 ...
 */
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || globalThis).marked = t();
}(void 0, function () {
  "use strict";
    ...
    return t.space = function (e) {
      ...
      if (t) {
        ...
        if (n.header.length === n.align.length) {
          ...
          for (r = n.cells.length, i = 0; i < r; i++) {
            n.cells[i] = O(n.cells[i].replace(/^ *\| *| *\| *$/g, ""), n.header.length);
          }
  ...
  var H = function () {
    ...
    return i.lex = function (e) {
      ...
      if (this.tokens.links) {
        ...
        if (0 < o.length) for (; null != (l = this.tokenizer.rules.inline.reflinkSearch.exec(a));) {
          o.includes(l[0].slice(l[0].lastIndexOf("[") + 1, -1)) && (a = a.slice(0, l.index) + "[" + "a".repeat(l[0].length - 2) + "]" + a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex));
        }
      }
        ...
        switch ((u = e[w]).type) {
          ...
          case "table":
            for (a = o = "", i = u.header.length, n = 0; n < i; n++) {
              a += this.renderer.tablecell(this.parseInline(u.tokens.header[n]), {
                header: !0,
                align: u.align[n]
              });
            }
            ...
            for (o += this.renderer.tablerow(a), c = "", i = u.cells.length, n = 0; n < i; n++) {
              for (a = "", s = (l = u.tokens.cells[n]).length, r = 0; r < s; r++) {
          ...
          case "list":
            for (p = u.ordered, h = u.start, g = u.loose, i = u.items.length, c = "", n = 0; n < i; n++) {
              k = (d = u.items[n]).checked, b = d.task, f = "", d.task && (m = this.renderer.checkbox(k), g ? 0 < d.tokens.length && "text" === d.tokens[0].type ? (d.tokens[0].text = m + " " + d.tokens[0].text, d.tokens[0].tokens && 0 < d.tokens[0].tokens.length && "text" === d.tokens[0].tokens[0].type && (d.tokens[0].tokens[0].text = m + " " + d.tokens[0].tokens[0].text)) : d.tokens.unshift({
                type: "text",
                text: m
          ...
          case "text":
            for (c = u.tokens ? this.parseInline(u.tokens) : u.text; w + 1 < v && "text" === e[w + 1].type;) {
